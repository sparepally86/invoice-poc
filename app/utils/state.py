...
STATUS_TRANSITIONS = {
    ...
    "VALIDATED": {"MATCHED", "CODED", "EXCEPTION", "PENDING_APPROVAL", "READY_FOR_POSTING"},
    "MATCHED": {"CODED", "PENDING_APPROVAL", "APPROVED", "EXCEPTION"},
    "CODED": {"PENDING_APPROVAL", "APPROVED", "EXCEPTION", "READY_FOR_POSTING"},
